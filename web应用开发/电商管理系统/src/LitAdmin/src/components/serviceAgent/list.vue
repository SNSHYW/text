  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table :data="books" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="S_ID" label="服务商ID" width="200"></el-table-column>
        <el-table-column prop="user_name" label="服务商名称" width="200"></el-table-column>
        <el-table-column prop="customernum" label="客服数量" sortable width="100"></el-table-column>
        <el-table-column prop="ordernum" label="订单总数" width="100" sortable></el-table-column>
...
<script>
  import API from '../../api/api_overview';
