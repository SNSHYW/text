  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table :data="books" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="O_ID" label="ID" width="60"></el-table-column>
        ...
        <el-table-column prop="S_ID" label="上级id" width="150" sortable></el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync ="editFormVisible" :close-on-click-modal="false">
        <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
          ...
          <el-form-item label="上级" prop="S_ID">
      ...
      <el-dialog title="新增" :visible.sync ="addFormVisible" :close-on-click-modal="false">
        <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
           <el-form-item label="客服ID" prop="O_ID">
            <el-input v-model="addForm.O_ID" auto-complete="off"></el-input>
          </el-form-item>
           <el-form-item label="姓名" prop="NAME">
    ...
    methods: {
      ...
      delBook: function (index, row) {
        ...
        this.$confirm('确认删除该记录吗?', '提示', {type: 'warning'}).then(() => {
          that.loading = true;
          API.remove(row.O_ID).then(function (result) {
            that.loading = false;
      ...
      editSubmit: function () {
        ...
        this.$refs.editForm.validate((valid) => {
          if (valid) {
            ...
            API.update(para.O_ID, para).then(function (result) {
              that.loading = false;
              if (result && parseInt(result.errcode) === 0) {
